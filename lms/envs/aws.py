...
EMAIL_HOST_USER = AUTH_TOKENS.get('EMAIL_HOST_USER', 'm15994219982@163.com')  # django default is ''
EMAIL_HOST_PASSWORD = AUTH_TOKENS.get('EMAIL_HOST_PASSWORD', '19910803xuxiao')  # django default is ''
...
AUTHENTICATION_BACKENDS += ('oauth_tianyuyun.auth_backend.OAuthBackend', )
